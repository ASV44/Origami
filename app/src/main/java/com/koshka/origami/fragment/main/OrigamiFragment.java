...
public class OrigamiFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        hover4.findViewById(R.id.cat).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent getWebPage = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/qm0937/Origami"));
        ...
        hover4.findViewById(R.id.mail).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                emailIntent.putExtra(android.content.Intent.EXTRA_EMAIL, new String[]{"ghost@origami.com"});
                emailIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "About origami");
